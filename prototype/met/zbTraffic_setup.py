# File: prototype/met/zbTrafficsetup.py
...
class Launcher:
    def __init__(self, root):
        self.root=root
        root.title("zbTraffic - Setup zbTraffic Station Data")
        root.geometry("500x400")
        ttk.Label(root,text="Throwaway zbTraffic - Setup v3 - FIXED",font=("Arial",14,"bold")).pack(pady=10)
